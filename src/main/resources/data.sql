...
INSERT INTO memory (id, created_at, updated_at, status, genre, image_url, music_url,instrument, mood, tempo, text, baby_id, member_id)
VALUES
    (1, '2024-07-01 00:00:00', '2024-07-01 00:00:00', 'ACTIVE', 'ACOUSTIC', 'https://example.com/image1.jpg', 'https://example.com/music1.mp3','PIANO', 'HAPPY', 'FAST', 'Memory 1', 1, 1),
    (2, '2024-07-02 00:00:00', '2024-07-02 00:00:00', 'ACTIVE', 'BALLAD', 'https://example.com/image2.jpg', 'https://example.com/music2.mp3','BASE_GUITAR', 'BEAUTIFUL', 'MID', 'Memory 2', 1, 1),
    (3, '2024-07-03 00:00:00', '2024-07-03 00:00:00', 'ACTIVE', 'ELECTRONIC', 'https://example.com/image3.jpg', 'https://example.com/music3.mp3','VIOLIN', 'ENERGETIC', 'SLOW', 'Memory 3', 1, 1),
    (4, '2024-07-04 00:00:00', '2024-07-04 00:00:00', 'ACTIVE', 'HIPHOP', 'https://example.com/image4.jpg', 'https://example.com/music4.mp3','FLUTE', 'BRIGHT', 'FAST', 'Memory 4', 1, 1),
    (5, '2024-07-05 00:00:00', '2024-07-05 00:00:00', 'ACTIVE', 'INDIE', 'https://example.com/image5.jpg', 'https://example.com/music5.mp3','SAXOPHONE', 'LOVELY', 'MID', 'Memory 5', 1, 1),
    (6, '2024-07-06 00:00:00', '2024-07-06 00:00:00', 'ACTIVE', 'JAZZ', 'https://example.com/image6.jpg', 'https://example.com/music6.mp3','TRUMPET', 'FANTASTIC', 'SLOW', 'Memory 6', 1, 1),
    (7, '2024-07-07 00:00:00', '2024-07-07 00:00:00', 'ACTIVE', 'POP', 'https://example.com/image7.jpg', 'https://example.com/music7.mp3','VIOLA', 'PEACEFUL', 'FAST', 'Memory 7', 1, 1),
    (8, '2024-07-08 00:00:00', '2024-07-08 00:00:00', 'ACTIVE', 'RNB', 'https://example.com/image8.jpg', 'https://example.com/music8.mp3','CLARINET', 'TOUCHING', 'MID', 'Memory 8', 1, 1),
    (9, '2024-07-09 00:00:00', '2024-07-09 00:00:00', 'ACTIVE', 'ROCK', 'https://example.com/image9.jpg', 'https://example.com/music9.mp3','XYLOPHONE', 'WARM', 'SLOW', 'Memory 9', 1, 1),
    (10, '2024-07-10 00:00:00', '2024-07-10 00:00:00', 'ACTIVE', 'ACOUSTIC', 'https://example.com/image10.jpg', 'https://example.com/music10.mp3','HARP', 'HAPPY', 'FAST', 'Memory 10', 1, 1),
    (11, '2024-07-5 00:00:00', '2024-07-5 00:00:00', 'ACTIVE', 'INDIE', 'https://example.com/image11.jpg', 'https://example.com/music11.mp3','TRUMPET', 'PEACEFUL', 'SLOW', 'Memory 10', 1, 2);
