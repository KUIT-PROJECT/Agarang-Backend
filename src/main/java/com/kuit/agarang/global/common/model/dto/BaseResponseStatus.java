...
public enum BaseResponseStatus {
  ...
  NOT_FOUND_REFRESH_TOKEN(false, HttpStatus.UNAUTHORIZED, 4015, "리프레시 토큰을 찾을 수 없습니다"),
  EXPIRED_REFRESH_TOKEN(false, HttpStatus.UNAUTHORIZED, 4016, "리프레시 토큰이 만료되었습니다."),
